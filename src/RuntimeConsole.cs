...
namespace LSLEditor
{
    ...
    {
        private readonly LSLEditorForm mainForm;
        ...
        {
            var blnResult = false;
            var assembly = CompilerHelper.CompileCSharp(this.editForm, this.CSharpCode);
            ...
            if (assembly != null)
            {
                ...
                this.SecondLifeHost.OnDie += this.host_OnDie;
                this.SecondLifeHost.OnReset += this.SecondLifeHost_OnReset;
                this.SecondLifeHost.OnListenChannelsChanged += this.SecondLifeHost_OnListenChannelsChanged;
                this.SecondLifeHost.OnVerboseMessage += this.host_OnVerboseMessage;
                this.SecondLifeHost.OnStateChange += this.host_OnStateChange;
        ...
        private void SecondLifeHost_OnListenChannelsChanged(object sender, EventArgs e)
        {
            ...
            {
                if (!(control is GroupboxEvent gbe))
                {
                    continue;
                }
        ...
        private void comboBox1_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            if (this.SecondLifeHost != null)
            {
                ...
                if (strStateName != "" && this.SecondLifeHost.CurrentStateName != strStateName)
                {
