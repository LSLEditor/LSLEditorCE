...
namespace LSLEditor
{
    public partial class UpdateApplicationForm : Form
    {
        ...
        private void StartDownloadinManifest()
        {
            ...
            this.manifest.DownloadStringCompleted += new DownloadStringCompletedEventHandler(this.manifest_DownloadCompleted);
        ...
        private void DownloadHelpFile()
        {
            if (this.strHelpUrl != null)
            {
                ...
                this.client.DownloadFileCompleted += new AsyncCompletedEventHandler(this.client_DownloadHelpFileCompleted);
        ...
        private void client_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            try
            {
                ...
                var strExtension = Path.GetExtension(strNewFileName);
                switch (strExtension)
                {
                    case ".bz2":
