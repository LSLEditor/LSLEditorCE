...
{
	partial class EnvironmentGeneral
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.groupBox3.Text = "auto update settings";
			// 
			// checkBox1
			// 
			...
			this.radioButton4.Text = "once a week";
			...
			this.radioButton3.Text = "once a day";
			...
			this.groupBox2.Text = "window layout";
			// 
			// radioButton1
			// 
			...
			this.radioButton2.Text = "Windowed documents";
			...
			this.groupBox1.Text = "recent file list";
			// 
			// label2
			// 
			...
			this.label2.Text = "recent projects list length";
			// 
			// label1
			// 
			...
			this.label1.Text = "recent files list length";
			// 
			// textBox2
			// 
			...
			this.groupBox4.Location = new System.Drawing.Point(200, 176);
			this.groupBox4.Name = "groupBox4";
			this.groupBox4.Size = new System.Drawing.Size(192, 96);
			this.groupBox4.TabIndex = 8;
			this.groupBox4.TabStop = false;
			this.groupBox4.Text = "auto update files";
			// 
			// checkBox2
			// 
			...
			this.checkBox2.Text = "delete old files after update";
