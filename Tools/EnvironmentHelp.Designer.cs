namespace LSLEditor.Tools
{
	partial class EnvironmentHelp
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox6.Size = new System.Drawing.Size(392, 112);
			this.groupBox6.TabIndex = 12;
			this.groupBox6.TabStop = false;
			this.groupBox6.Text = "wiki help pages";
			// 
			// button2
			// 
			...
			this.button2.Text = "wiki.secondlife.com";
			...
			this.label1.Text = "Using LSLEditorHelp.chm file";
			// 
			// textBox1
			// 
			...
			this.radioButton2.Text = "Offline Wiki";
			...
			this.radioButton1.Text = "Online Wiki";
			...
			this.groupBox1.Text = "online wiki pages";
			// 
			// checkBox1
			// 
			this.checkBox1.AutoSize = true;
			this.checkBox1.Location = new System.Drawing.Point(152, 48);
			this.checkBox1.Name = "checkBox1";
			this.checkBox1.Size = new System.Drawing.Size(145, 17);
			this.checkBox1.TabIndex = 0;
			this.checkBox1.Text = "New tab for every search";
			...
			this.checkBox2.Text = "Use tooltips on keywords when hovering script text";
			...
			this.radioButton3.Text = "external webbrowser";
			...
			this.radioButton4.Text = "internal webbrowser";
